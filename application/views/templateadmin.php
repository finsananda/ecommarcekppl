...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url()."template/AdminLTE/bower_components/morris.js/morris.css";?>">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url()."template/AdminLTE/bower_components/jvectormap/jquery-jvectormap.css";?>">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?php echo base_url()."template/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css";?>">
          ...
          <?php
                        ...
                        foreach ($main as $m ){
                            ...
                            if($sub->num_rows()>0){
                                ...
                                echo anchor('#', '<i class="fa fa-dashboard"></i> '.strtoupper($m->nama_menu).' <i class="fa fa-angle-left pull-right"></i>');
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url()?>template/AdminLTE/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url()?>template/AdminLTE/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo base_url()?>template/AdminLTE/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url()?>template/AdminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo base_url()?>template/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url()?>template/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url()?>template/AdminLTE/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url()?>template/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
